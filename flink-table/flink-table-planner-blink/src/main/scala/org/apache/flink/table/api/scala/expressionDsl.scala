...
//  def concat_agg(separator: Expression): Expression = unresolvedCall(CONCAT_AGG, expr, separator)
  ...
  /**
    ...
    */
  def ?(ifTrue: Expression, ifFalse: Expression): Expression = unresolvedCall(
...
trait ImplicitExpressionConversions {
  ...
  /**
    ...
    * partition.
    */
  implicit val UNBOUNDED_RANGE: Expression = unresolvedCall(
  ...
  implicit class ScalarFunctionunresolvedCall(val s: ScalarFunction) {
  ...
  implicit class TableFunctionCall[T: TypeInformation](val t: TableFunction[T]) {
    ...
    def apply(params: Expression*): Expression = {
      ...
      unresolvedCall(new TableFunctionDefinition(t.getClass.getName, t, resultType), params: _*)
    }
  }
