...
import org.apache.flink.table.api.{GroupWindow, OverWindow, ValidationException}
...
import org.apache.flink.table.expressions.{ApiExpressionDefaultVisitor, ApiExpressionUtils, Expression, ExpressionResolver, ExpressionUtils, LocalReferenceExpression, LookupCallResolver, ResolvedExpression, UnresolvedCallExpression, UnresolvedReferenceExpression}
...
class OperationTreeBuilderImpl(
  ...
  private def resolveSingleExpression(
      ...
      resolver: ExpressionResolver): ResolvedExpression = {
