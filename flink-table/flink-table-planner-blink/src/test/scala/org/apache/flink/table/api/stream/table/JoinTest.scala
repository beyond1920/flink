...
class JoinTest extends TableTestBase {
  ...
  def testRowTimeWindowInnerJoin(): Unit = {
    ...
    val left = util.addDataStream[(Long, Int, String)]("T1", 'a, 'b, 'c, 'rowtime)
    val right = util.addDataStream[(Long, Int, String)]("T2",'d, 'e, 'f, 'rowtime)
  ...
  def testProcTimeWindowInnerJoin(): Unit = {
    val util = streamTestUtil()
    val left = util.addDataStream[(Long, Int, String)]("T1", 'a, 'b, 'c, 'proctime)
    val right = util.addDataStream[(Long, Int, String)]("T2",'d, 'e, 'f, 'proctime)
  ...
  def testRowTimeInnerJoinWithTimeAccessed(): Unit = {
    val util = streamTestUtil()
    val left = util.addDataStream[(Long, Int, Timestamp)]("T1",'a, 'b, 'c, 'rowtime)
    val right = util.addDataStream[(Long, Int, Timestamp)]("T2",'d, 'e, 'f, 'rowtime)
