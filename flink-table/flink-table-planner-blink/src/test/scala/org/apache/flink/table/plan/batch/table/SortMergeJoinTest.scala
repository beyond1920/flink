...
class SortMergeJoinTest extends TableTestBase {
  ...
  def testInnerJoin(): Unit = {
    val table1 = util.addTableSource[(Int, Long, String)]("Table3", 'a, 'b, 'c)
    val table2 = util.addTableSource[(Int, Long, Int, String, Long)]("Table5", 'd, 'e, 'f, 'g, 'h)
  ...
  def testInnerJoinWithFilter(): Unit = {
    val table1 = util.addTableSource[(Int, Long, Int, String, Long)]("Table5", 'd, 'e, 'f, 'g, 'h)
    val table2 = util.addTableSource[(Int, Long, String)]("Table3", 'a, 'b, 'c)
